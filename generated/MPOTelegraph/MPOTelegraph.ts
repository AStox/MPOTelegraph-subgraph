...
export class MPOTelegraph extends ethereum.SmartContract {
  static bind(address: Address): MPOTelegraph {
    return new MPOTelegraph("MPOTelegraph", address);
  }
  ...
  isApprovedForAll(_owner: Address, _candidate: Address): boolean {
    let result = super.call(
      "isApprovedForAll",
      "isApprovedForAll(address,address):(bool)",
      [
        ethereum.Value.fromAddress(_owner),
        ethereum.Value.fromAddress(_candidate)
      ]
    );
