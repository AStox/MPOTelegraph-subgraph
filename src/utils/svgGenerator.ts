...
function parseMessage(message: string): string {
  ...
  for (let i = 0; i < numLines; i++) {
    ...
    let line = `<tspan x="0" dy="20"><tspan class="muted">></tspan><tspan>${lineMsg}`;
